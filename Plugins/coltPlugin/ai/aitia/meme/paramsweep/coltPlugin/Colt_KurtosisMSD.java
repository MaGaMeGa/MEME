...
public class Colt_KurtosisMSD implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Kurtosis from mean and standard deviation"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.kurtosis"; }
	...
	public List<String> getParameterDescriptions() {
		return Arrays.asList(new String[] { "Data sequence", "Mean", "Standard deviation" });
	}
}
