GLOBALS [ param1 param2 param3 param4 param5 bool-list xx y x testvalue agentlist]
...
;;  random-seed 0
  ...
  set param3 10
  set param4 "text"
  set param5 (turtles with [energy = 0])
  show count (param5 with [energy != 0])
  set bool-list [ false true false ]
  set y [ 1 2 10]
  set xx param5 with [who > 10]
  set x param5 with [who < 5]
  let al sort param5
  set testvalue 0
  show 1 != 2
  ;aasdasdas
  ...
  show ";"
  show "hello;" ; bello
  show "dasdasd\"dasdasd;"
  show "dasdasd\\"; param1
  set agentlist sort param5
  test
  reset-ticks
end
