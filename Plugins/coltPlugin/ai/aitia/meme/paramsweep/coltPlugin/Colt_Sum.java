...
/** Statistic method decriptor plugin. This method returns the sum of a data sequence.
 *  That is Sum( data[i] ).
 */
public class Colt_Sum implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Sum"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.sum"; }
	...
	public String getDescription() { return "Computes the sum of a data sequence."; }
