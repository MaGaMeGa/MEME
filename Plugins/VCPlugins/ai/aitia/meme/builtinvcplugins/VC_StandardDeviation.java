...
public class VC_StandardDeviation extends ColtBuiltinFn {

	//====================================================================================================
	// implemented interfaces

	public String getLocalizedName() { return "STANDARD_DEVIATION()"; }
	
	//----------------------------------------------------------------------------------------------------
	public Object compute(final IContext context) {
		final DoubleArrayList dal = convert2DAL(context);
		return Descriptive.standardDeviation(dal);
	}
}
