 ...
 *  sequence must not be less or equal to zero.<br> The geometric mean is given by
 *  pow( Product( data[i] ), 1/data.size()). This method tries to avoid overflows at the
 *  expense of an equivalent but somewhat slow definition:
 *  geo = Math.exp( Sum( Log(data[i]) ) / data.size()).
 */
public class Colt_GeometricMean implements IStatisticsPlugin {

	//=======================================================================================
	// methods
	
	//---------------------------------------------------------------------------------------
	public String getName() { return "geometricMean"; }
	public String getLocalizedName() { return "Geometric mean"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.geometricMean"; }
	...
	public String getDescription() { return "Computes the geometric mean of a data sequence."; }
