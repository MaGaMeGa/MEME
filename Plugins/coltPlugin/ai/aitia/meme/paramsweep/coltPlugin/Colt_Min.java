...
/** Statistic method decriptor plugin. This method returns the smallest member of a data
 *  sequence.
 */
public class Colt_Min implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Minimum"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.min"; }
	...
	public String getDescription() { return "Computes the smallest member of a data sequence."; }
