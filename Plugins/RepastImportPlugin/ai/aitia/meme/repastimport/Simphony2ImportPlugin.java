...
/** Plugin for imports Repast result files. */
public class Simphony2ImportPlugin implements IImportPlugin
{
	//-------------------------------------------------------------------------
	public String getLocalizedName() {
		return "Repast Simphony 2 result file";
	}

	//-------------------------------------------------------------------------
	public java.awt.Window showDialog(IImportPluginContext ctx) {
		String resultType = "Repast Simphony 2";
		java.io.File f[] = null;
