...
import ai.aitia.meme.paramsweep.platform.simphony2.Simphony2JavaPlatform;
...
public class Simphony2ModelGenerator {
	...
	private final CtClass simphony2Interface;
	 ...
	 */
	public Simphony2ModelGenerator(final ClassPool pool, final CtClass ancestor, final List<RecorderInfo> recorders, final String stopData,
		...
		try {
			...
			this.simphony2Interface = this.pool.get("ai.aitia.meme.paramsweep.platform.simphony2.impl.ISimphony2GeneratedModel");
	...
	public String generateModel() {
		...
		try {
			...
			model.addInterface(simphony2Interface);
			
			if (description != null && description.trim().length() > 0)
				source.append("/* " + description + " */\n");
			source.append("public class " + model.getSimpleName() + " extends " + ancestor.getName() + " implements " +
					      generatedInterface.getSimpleName() + ", " + simphony2Interface.getSimpleName() + " {\n\n");
			
			// implementing ISimphony2GeneratedModel interface
	...
	private void importPackages() {
		...
		imports.add("ai.aitia.meme.paramsweep.platform.simphony2");
	...
	private String generateRecorders(final CtClass model) throws CannotCompileException {
		...
		sb.append("String recorderPathPrefix = System.getProperty(\"" + Simphony2JavaPlatform.recorderPrefix + "\",\"\");\n");
