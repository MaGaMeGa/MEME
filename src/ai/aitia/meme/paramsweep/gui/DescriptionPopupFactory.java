...
public class DescriptionPopupFactory {
	...
	private static final int DEFAULT_POPUP_TEXT_LENGTH = 40;
	...
	public Popup getPopup(final Component owner, final String description) {
		final PopupFactory popupFactory = PopupFactory.getSharedInstance();
		final int periodIndex = description.indexOf('.');
		final int exclamationMarkIndex = description.indexOf('!');
		final int questionMarkIndex = description.indexOf('?');
		...
		final String firstSentence = endOfSentence == description.length() ? description : description.substring(0, endOfSentence + 1)
				+ " ...";
