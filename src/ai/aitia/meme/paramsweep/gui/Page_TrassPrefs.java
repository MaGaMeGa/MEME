...
public class Page_TrassPrefs extends PreferencesPage implements	IReinitalizeable, ActionListener {
	 ...
	 */
	public Page_TrassPrefs(WizardPreferences owner) {
		super("Trass");
		this.owner = owner;
		layoutGUI();
		reinitialize();
	...
	//-------------------------------------------------------------------------------------
	@Override public String getInfoText(Preferences p) { return "Trass properties."; }
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ("REGISTER".equals(cmd)) {
			PlatformManager.registerPlatform(PlatformType.TRASS,".");
			...
			if (result == 1) {
				PlatformManager.removePlatform(PlatformType.TRASS);
