...
public class OrderMethod implements IIntelliStaticMethodPlugin {
	...
	public String getDescription() {
		return "If you are in need of a Design of Experiments method for MEME, " +
				"please contact us at our website: http://mass.aitia.ai\n\n" +
				"Thank you.";
	}
