...
public class Colt_WinsorizedMeanM implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Winsorized mean from mean"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.winsorizedMean"; }
