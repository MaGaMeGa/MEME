...
public class Simphony2BatchController implements IBatchController {
	...
	private ISimphony2GeneratedModel model = null; 
	...
	//----------------------------------------------------------------------------------------------------
	public Simphony2BatchController(String generatedModelName, boolean local) {
...
//			noRuns = temp;
	...
	public void setEntryPoint(String entryPoint) throws InvalidEntryPointException {
		try {
			...
			model = (ISimphony2GeneratedModel) modelClass.newInstance();
		} catch (Exception e) {
	...
	private void fillMethodTable(List<AbstractParameterInfo> combination) { 
		try {
			setParameterMethod = modelClass.getMethod(Simphony2ModelInformation.SET_PARAMETER,String.class,Object.class);
		} catch (Exception e) {
