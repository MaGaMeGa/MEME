...
public class Math_Division implements IStatisticsPlugin {
	...
	public String getFullyQualifiedName() { return "ai.aitia.meme.paramsweep.colt.Descriptive.division2"; }
	...
	public List<String> getParameterDescriptions() { return Arrays.asList(new String[] { "Divident", "Divisor" }); }
	public Class getReturnType() { return Double.TYPE; }
	public String getDescription() { return "Returns the quotient of its arguments (a / b)."; }
}
