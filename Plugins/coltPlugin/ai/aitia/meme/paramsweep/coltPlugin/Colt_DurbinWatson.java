...
/** Statistic method decriptor plugin. Durbin-Watson computation. */
public class Colt_DurbinWatson implements IStatisticsPlugin {

	//=======================================================================================
	// methods
	
	//---------------------------------------------------------------------------------------
	public String getName() { return "durbinWatson"; }
	public String getLocalizedName() { return "Durbin-Watson statistic"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.durbinWatson"; }
	...
	public String getDescription() { return "Computes the Durbin-Watson statistic of a data sequence."; }
