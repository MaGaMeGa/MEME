...
public class Page_Simphony2Prefs extends PreferencesPage implements IReinitalizeable, ActionListener {
	//=====================================================================================
	//members
	 ...
	 */
	public Page_Simphony2Prefs(WizardPreferences owner) {
		super("Repast Simphony 2.0");
		this.owner = owner;
		layoutGUI();
		reinitialize();
	}
	...
	public void reinitialize() {
		...
		String installationDirectory = PlatformManager.getInstallationDirectory(PlatformType.SIMPHONY2);
		...
		sourceCheckBox.setSelected(Boolean.parseBoolean(p.getProperty(WizardPreferences.REPASTS2_SOURCE_GENERATION)));
		closeAfterOneScriptCheckBox.setSelected(Boolean.parseBoolean(p.getProperty(WizardPreferences.REPASTS2_CLOSE_AFTER_ONE_SCRIPT)));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ("BROWSE".equals(cmd)) {
			...
			if (PlatformManager.registerPlatform(PlatformType.SIMPHONY2,dir.getAbsolutePath())){
			...
			if (result == 1) {
				PlatformManager.removePlatform(PlatformType.SIMPHONY2);
	...
	public boolean onButtonPress(Button b) {
		...
		case OK		: Properties p = owner.getProperties();
					  p.setProperty(WizardPreferences.REPASTS2_SOURCE_GENERATION,String.valueOf(sourceCheckBox.isSelected()));
					  p.setProperty(WizardPreferences.REPASTS2_CLOSE_AFTER_ONE_SCRIPT,String.valueOf(closeAfterOneScriptCheckBox.isSelected()));
		}
		return true;
	}
...
//									  registerButton,deRegisterButton).getPanel();	
		...
		content = FormsUtils.build("p ~ p:g ~ p ",
				   "[DialogBorder]000||" +
				   				 ...
				   				 "333|" +
				   				 "444",
				   "A platform for Repast Simphony 2 models.",
				   tmp,
