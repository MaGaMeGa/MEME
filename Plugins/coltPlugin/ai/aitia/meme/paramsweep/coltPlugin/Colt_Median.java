...
/** Statistic method decriptor plugin. This method returns the median of a sorted data
 *  sequence.
 *  <p>
 *  <b>Parameters:</b>
 ...
 */
public class Colt_Median implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Median"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.median"; }
	public int getNumberOfParameters() { return 1; }
	public List<String> getParameterNames() { return Arrays.asList(new String[] { "data" }); }
	public List<Class> getParameterTypes() { return Arrays.asList(new Class[] { SortedDoubleArrayList.class }); }
	public Class getReturnType() { return Double.TYPE; }
	public String getDescription() { return "Computes the median of a data sequence."; }
