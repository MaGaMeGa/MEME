...
public class Recorder {
	...
	protected ISimphony2GeneratedModel model = null;
	...
	//----------------------------------------------------------------------------------------------------
	public Recorder(String fileName, ISimphony2GeneratedModel model) { this(fileName,model,"|"); }
	
	//----------------------------------------------------------------------------------------------------
	public Recorder(String fileName, ISimphony2GeneratedModel model, String delimiter) {
