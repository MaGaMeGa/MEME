...
public class Math_Subtraction implements IStatisticsPlugin {
	...
	public String getFullyQualifiedName() { return "ai.aitia.meme.paramsweep.colt.Descriptive.subtraction2"; }
	...
	public List<String> getParameterDescriptions() { return Arrays.asList(new String[] { "Minuend", "Subtrahend" }); }
	public Class getReturnType() { return Double.TYPE; }
	public String getDescription() { return "Returns the difference between its arguments (a - b)."; }
}
