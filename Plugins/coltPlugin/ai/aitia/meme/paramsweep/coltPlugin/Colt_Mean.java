...
/** Statistic method decriptor plugin. This method returns the arithmetic mean of a data
 *  sequence; That is Sum( data[i] ) / data.size().
 */
public class Colt_Mean implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Mean"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.mean"; }
	...
	public String getDescription() { return "Computes the arithmetic mean of a data sequence."; }
