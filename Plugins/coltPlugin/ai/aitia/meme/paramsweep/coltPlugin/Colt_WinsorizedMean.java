...
/** Statistic method decriptor plugin. This method returns the winsorized mean of a
 ...
 */
public class Colt_WinsorizedMean implements IStatisticsPlugin {

	//=======================================================================================
	// methods
	
	//---------------------------------------------------------------------------------------
	public String getName() { return "winsorizedMean"; }
	public String getLocalizedName() { return "Winsorized mean"; }
	public String getFullyQualifiedName() { return "ai.aitia.meme.paramsweep.colt.Descriptive.winsorizedMean"; }
	...
	public String getDescription() { return "Computes the winsorized mean of a data sequence."; }
