...
copy ..\ParamSweep.pack			releasetmp
copy ..\meme-paramsweep.pack		releasetmp
copy C:\works\MEMEParamSweep\lib\*.jar	releasetmp\lib
copy ..\resources\*.*			releasetmp\resources
copy ..\usertools.xml			releasetmp
