...
/** Statistic method decriptor plugin. This method returns the standard error of a data
 *  sequence. That is Math.sqrt(variance/size).
 */
public class Colt_StandardError implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Standard error"; }
	public String getFullyQualifiedName() { return "ai.aitia.meme.paramsweep.colt.Descriptive.standardError"; }
