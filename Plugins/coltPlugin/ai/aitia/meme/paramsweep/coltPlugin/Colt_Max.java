...
/** Statistic method decriptor plugin. This method returns the largest member of a data
 *  sequence.
 */
public class Colt_Max implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Maximum"; }
	public String getFullyQualifiedName() { return "cern.jet.stat.Descriptive.max"; }
	...
	public String getDescription() { return "Computes the largest member of a data sequence."; }
