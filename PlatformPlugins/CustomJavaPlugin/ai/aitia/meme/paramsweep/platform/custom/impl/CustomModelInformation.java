...
public class CustomModelInformation implements IModelInformation {
	...
	//----------------------------------------------------------------------------------------------------
	public CustomModelInformation(IPSWInformationProvider provider, CtClass modelClass) {
	...
	private String collectParameters() {
		...
		try {
			...
			// we checked the existense of these methods in the CustomJavaPlatform.checkModel() method
