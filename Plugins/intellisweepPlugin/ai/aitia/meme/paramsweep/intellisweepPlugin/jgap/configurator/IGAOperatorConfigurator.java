 ...
 * {@link GeneticOperator} instances.
 * 
 * @author Tamás Máhr
 * 
 */
public interface IGAOperatorConfigurator extends IGAConfigurator {
	
	//====================================================================================================
	// methods
	
	/**
	 * Returns the genetic operator based on the values set on the settings panel.
	 * 
