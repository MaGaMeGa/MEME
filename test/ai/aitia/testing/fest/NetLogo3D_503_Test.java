...
import ai.aitia.testing.fest.CompNames.Fld.NLogoImport;

@RunWith(GUITestRunner.class)
public class NetLogo3D_503_Test
{
    ...
    public void testNlogo()
    {
    	Pause.pause(1000);
       	...
       	int methodIndex = setModel("netlogo 5.0.3", "Mousetraps3D5.nlogo3d","static", true);
        ...
        nlogoDialog.textBox(CompNames.Fld.NLogoImport.MODELNAME).enterText("nlogo3d_503 model test");
