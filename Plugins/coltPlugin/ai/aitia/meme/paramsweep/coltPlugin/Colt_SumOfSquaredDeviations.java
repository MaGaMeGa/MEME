...
/** Statistic method decriptor plugin. This method returns the sum of squared mean
 *  deviation of of a data sequence. That is variance * (size-1) == Sum( (data[i] -
 *  mean)<sup>2</sup> ).
 */
public class Colt_SumOfSquaredDeviations implements IStatisticsPlugin {
	...
	public String getLocalizedName() { return "Sum of squared mean deviations"; }
	public String getFullyQualifiedName() { return "ai.aitia.meme.paramsweep.colt.Descriptive.sumOfSquaredDeviations"; }
