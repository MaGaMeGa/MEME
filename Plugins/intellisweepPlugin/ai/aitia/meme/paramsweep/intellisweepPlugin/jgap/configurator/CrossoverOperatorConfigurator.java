...
public class CrossoverOperatorConfigurator implements IGAOperatorConfigurator {
	...
	private static final long serialVersionUID = 4951384155055788870L;
	...
	public String getDescription() {
		return "The crossover operator randomly selects two Chromosomes from the population and 'mates' them by randomly picking a gene and then swapping that gene and all "
				+ "subsequent genes between the two Chromosomes. The two modified Chromosomes are then added to the list of candidate Chromosomes.";
	}
