 ...
 *  
 *  Modified by Rajmund Bocsi (adding generic parameters)
 */
/**
 * 
 * @author Rob Camick
 *
 */
public class ListAction<E> implements MouseListener {
	 ...
	 */
	public ListAction(JList<E> list, Action action) {
	 ...
	 */
	public ListAction(JList<E> list, Action action, KeyStroke keyStroke) {
		this.list = list;
