...
//		vName = vName.replace('ï¿½','a');
//		vName = vName.replace('ï¿½','e');
//		vName = vName.replace('ï¿½','i');
//		vName = vName.replace('ï¿½','o');
//		vName = vName.replace('ï¿½','o');
//		vName = vName.replace('ï¿½','o');
//		vName = vName.replace('ï¿½','u');
//		vName = vName.replace('ï¿½','u');
//		vName = vName.replace('ï¿½','u');
//		vName = vName.replace('ï¿½','A');
//		vName = vName.replace('ï¿½','E');
...
//		vName = vName.replace('ï¿½','U');
		...
		vName = vName.replace('õ','o');
		vName = vName.replace('ö','o');
		vName = vName.replace('ú','u');
		vName = vName.replace('û','u');
