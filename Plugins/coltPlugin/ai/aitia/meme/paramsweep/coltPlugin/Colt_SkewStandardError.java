 ...
 *  sample skew. Ref: R.R. Sokal, F.J. Rohlf, Biometry: the principles and practice of
 *  statistics in biological research (W.H. Freeman and Company, New York, 1998, 3rd
 *  edition) p. 138.
 */
public class Colt_SkewStandardError implements IStatisticsPlugin {

	//=======================================================================================
	// methods
	
	//---------------------------------------------------------------------------------------
	public String getName() { return "skewStandardError"; }
	public String getLocalizedName() { return "Standard error of the skew"; }
	public String getFullyQualifiedName() { return "ai.aitia.meme.paramsweep.colt.Descriptive.skewStandardError"; }
	...
	public String getDescription() { return "Computes the standard error of the skew."; }
