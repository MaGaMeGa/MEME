...
public class NetLogo3D_412_Test{
	...
	private static void registerPlatforms() {
		...
		jtf.selectPath("/Platforms/NetLogo-4");
		prefDial.button(CompNames.Btn.Preferences.BROWSE).click();
		jfc = JFileChooserFinder.findFileChooser().using(robot);
		jfc.setCurrentDirectory(new File(projectPath
				+sep+ "Platforms"+sep+"NetLogo4.1"));
		jfc.approve();
    ...
    public void testNlogo()
    {
    	Pause.pause(1000);
       	...
       	int methodIndex = setModel("netlogo 4.1.2", "Mousetraps3D4.1.nlogo","static", true);
